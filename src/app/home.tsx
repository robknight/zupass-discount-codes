        ...
        <div className="container">
          ...
          <div className="pt-4 border-t border-gray-800">
            <div className="flex items-center justify-between">
              <div className="micro-text" style={{color: 'rgba(240, 239, 232, 0.6)'}}>
                {new Date().getFullYear()} DappCon Discount Portal. Powered by Zupass & Zero-Knowledge Proofs.
              </div>
              <a
                href="https://github.com/robknight/zupass-discount-codes"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="GitHub Repository"
                style={{ display: 'inline-flex', alignItems: 'center', color: 'rgba(240, 239, 232, 0.6)' }}
              >
